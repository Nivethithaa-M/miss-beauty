			...
			<div class="panel-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
						<input type="file" name="product_img1" class="form-control" required=""><br>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
						<input type="file" name="product_img2" class="form-control" required=""><br>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
						<textarea name="product_desc" class="form-control" rows="6" cols="19"><?php echo $p_desc; ?>
						</textarea>
					</div>
				</div>
					<div class="form-group">
						...
						<div class="col-md-6">
						<input type="submit" name="update" value="Update Product" class="btn btn-hotpink form-control">
					</div>
				</div>
				</form>
			</div>
